...
public class ClanManager {
    ...
    public static void setLeaderOfClan(UUID clanUUID, UserEntity user) throws ThisClanDoesNotExists, ThisUserDoesNotBelongToThisClan {
        ...
        if(!members.contains(user.getUuid())) throw new ThisUserDoesNotBelongToThisClan();

        clanEntity.setLeader(user);

        clanEntityManager.updateClanEntity(clanEntity);

        TeamManager.refreshTeam(clanEntity);
    }
    public static void setDeputyOfClan(UUID clanUUID, UserEntity user) throws ThisClanDoesNotExists, ThisUserDoesNotBelongToThisClan {
    ...
    public static void changePvpStatus(ClanEntity clanEntity) {

        clanEntity.setPvp(!clanEntity.isPvp());
        clanEntityManager.updateClanEntity(clanEntity);
