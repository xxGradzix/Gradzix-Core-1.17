...
public class Messages {
    ...
    public static final String  LEADER_COMMAND_USAGE = ChatColor.DARK_GRAY +"- " + ChatColor.GRAY + "/klan ustawlidera " + ChatColor.DARK_GRAY + " <" + ChatColor.GREEN + "nick" + ChatColor.DARK_GRAY + ">";
    public static final String  DEPUTY_COMMAND_USAGE = ChatColor.DARK_GRAY +"- " + ChatColor.GRAY + "/klan zastepca " + ChatColor.DARK_GRAY + " <" + ChatColor.GREEN + "nick" + ChatColor.DARK_GRAY + ">";
    ...
    public static String SUCCESFULLU_GRANTED_LEADER(String nick) {
        return ChatColor.GRAY + "Pomyślnie przekazałeś lidera klanu " + ChatColor.GREEN + nick;
    }
    public static String SUCCESFULLU_GRANTED_DEPUTY(String nick) {
        return ChatColor.GRAY + "Pomyślnie przekazałeś zastępce klanu " + ChatColor.GREEN + nick;
    }
