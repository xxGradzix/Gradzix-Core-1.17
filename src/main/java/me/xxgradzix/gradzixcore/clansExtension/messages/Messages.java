...
public class Messages {
    ...
    public static final String WRONG_COMMAND_USAGE = ChatColor.RED + "Poprawne użycie: /wojnyConfig schedule START rok,miesiąc,dzień,godzina,minuta END rok,miesiąc,dzień,godzina,minuta";
    public static final String WRONG_DATE = ChatColor.RED + "Data zakończenia wojny musi być późniejsza niż data rozpoczęcia i nie może być wcześniejsza niż obecna data";;
