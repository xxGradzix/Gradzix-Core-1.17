...
//
//    public SkinChangeFactory(JavaPlugin plugin) {
//
//        protocolManager = ProtocolLibrary.getProtocolManager();
//
//        protocolManager.addPacketListener(new PacketAdapter(plugin, ListenerPriority.NORMAL, PacketType.Play.Server.NAMED_ENTITY_SPAWN) {
//            @Override
...
//                    Player pl = fromId(event.getPacket()..getUUIDs().read(0));
...
//
//                    ((CraftPlayer) willSee).getHandle().b.sendPacket(packet);
//
//                } catch (Exception e) {
//                    e.printStackTrace();
//                }
